...
def test_dataform_client_client_options_from_dict():
    with mock.patch('google.cloud.dataform_v1alpha2.services.dataform.transports.DataformGrpcTransport.__init__') as grpc_transport:
...
async def test_query_directory_contents_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.query_directory_contents(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_compilation_results_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_compilation_results(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_query_compilation_result_actions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.query_compilation_result_actions(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_workflow_invocations_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_workflow_invocations(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_query_workflow_invocation_actions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.query_workflow_invocation_actions(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_dataform_base_transport():
    ...
    with mock.patch('google.cloud.dataform_v1alpha2.services.dataform.transports.DataformTransport.__init__') as Transport:
...
def test_dataform_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dataform_v1alpha2.services.dataform.transports.DataformTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataform_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dataform_v1alpha2.services.dataform.transports.DataformTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataformTransport()
        adc.assert_called_once()
